...
| ----------------- | ---------- | ---- | ----------- | ------------ | ------ | -------- |
| s1-brdr1 | BGP | VerifyBGPPeerSession | Verifies the session state of BGP peers. | Generated by AVD | failure | Peer: 172.16.1.16 VRF: default - Incorrect session state - Expected: Established Actual: Connect<br>Peer: 172.16.1.18 VRF: default - Incorrect session state - Expected: Established Actual: Active |
